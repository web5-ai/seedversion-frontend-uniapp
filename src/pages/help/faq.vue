  ...
  data() {
    return {
      ...
      faqs: [
        ...
        {
          question: '油脂和蛋白质含量代表什么？',
          answer: '油脂和蛋白质是油菜籽的两个主要营养成分：\n\n油脂：反映种子含油量，是评价油菜籽品质的重要指标，含量通常在32.5-50.5%之间\n蛋白质：是油菜籽的次要成分，含量一般在17.4-32.5%之间，是优质的植物蛋白来源\n\n高品质油菜籽通常具有较高的含油量，同时保持适中的蛋白质含量。这两个指标的比例对油菜籽的综合品质和经济价值有重要影响。',
          category: 'data'
        },
        {
