...
- 推荐使用IDE   HBuilderX，可以一键完成下面所有的依赖下载和运行发行
- Node.js 12.0 或更高版本
- npm 或 yarn 包管理工具
...
### HbuilderX
1. 安卓APP调试，推荐下载MuMu模拟器或者其他面向手机游戏运行的模拟器，相比Android Studio方便很多，不需要太多配置。只需要在HbuilderX中配置好模拟器adb的运行端口即可。
2. H5调试，推荐使用HbuilderX的调试，windows电脑直接运行到edge即可
3. APP打包，建议使用Hbuilderx的云打包功能，本地打包有很多配置要解决，很麻烦
